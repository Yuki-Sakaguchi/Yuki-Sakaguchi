...
| **🔮 gh-wizard** <br>A magical GitHub CLI extension that creates repositories using template repositories with an intuitive, create-next-app style interface.<br><br>Features beautiful progressive disclosure UI, automatic template discovery, terminal-optimized display with CJK character support, and cross-platform compatibility. Built as a GitHub CLI extension for seamless integration.<br><br>Developed using TDD methodology with comprehensive test coverage and modern Go practices.<br><br> Go / GitHub CLI / Survey / go-gh / runewidth / Cobra<br><br><a href="https://github.com/Yuki-Sakaguchi/gh-wizard" target="_blank"><img alt="GitHub Release" src="https://img.shields.io/github/v/release/Yuki-Sakaguchi/gh-wizard"></a> | <a href="https://github.com/Yuki-Sakaguchi/gh-wizard">gh extension install Yuki-Sakaguchi/gh-wizard</a> |
