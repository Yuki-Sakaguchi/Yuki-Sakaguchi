...
const yu = {
  ...
  favorites: {
    code: ["typescript", "react", "Expo", "Supabase", "Claude Code"],
    tools: ["vim", "HHKB"],
...
| description  | images |
| ------------- | :-------------: |
| **👾 dottomon** <br>An npm package that turns any name into a unique pixel art monster. Deterministic — the same seed always generates the same monster.<br><br>Features 4-direction views with 2-frame walk animations, RPG-style stats (HP, MP, attack, etc.), and 3 generation presets (mochi / retro / chaos). Zero dependencies, works in browsers, Node.js, and Workers. Also provides an optional React component and a CLI.<br><br> TypeScript / SVG / React / Node.js<br><br><a href="https://www.npmjs.com/package/dottomon" target="_blank"><img alt="NPM Version" src="https://img.shields.io/npm/v/dottomon"></a> <a href="https://www.npmcharts.com/compare/dottomon?minimal=true" target="_blank"><img alt="NPM Downloads" src="https://img.shields.io/npm/d18m/dottomon"></a> | <a href="https://dottomon-org.github.io/dottomon-web/"><img src="https://github.com/user-attachments/assets/db6e9728-eff7-414c-abd0-c3819b292637" width="400px" />https://dottomon-org.github.io/dottomon-web/</a> |
| **📂 Tree Idea Maker** <br>An app for thinking up ideas for directory structures.<br><br>You can copy the directory structure you created in tree format.<br>You can also import from tree format and reflect the directory structure of your local workspace.<br><br> Next.js / Tailwind CSS / shadcn/ui / zustand / zod / Vitest / Playwright | <a href="https://tree-idea-maker.vercel.app/"><img src="https://github.com/user-attachments/assets/0ff8f8bc-34b3-4931-a4aa-0fd341e36695" width="400px" /><br>https://tree-idea-maker.vercel.app/</a> |
| **🥊 Watch Rush** <br>A web app for watching multiple videos at the same time.<br>This is used when multiple streamers are simultaneously live on Twitch, etc.<br><br>Only the audio for the focused video will be turned on, so you can smoothly switch to the audio for other videos.<br><br> Next.js / Tailwind CSS / shadcn/ui / zustand | <img src="https://github.com/user-attachments/assets/6ce45243-eb16-4c54-b9c8-d94c0680a479" width="400px" /><br><a href="https://watch-rush.vercel.app/">https://watch-rush.vercel.app/</a> |
| [📄 rirekisho CLI](https://github.com/Yuki-Sakaguchi/rirekisho-cli)<br>A CLI tool for generating Japanese resumes (履歴書) for engineers.<br><br>Generate beautiful resume PDFs automatically from YAML files. Creates professional resumes with JIS-compliant layouts that meet Japanese business standards.<br><br>Built with vibe-driven coding using Cursor AI - developed through intuitive flow and AI-assisted programming for rapid prototyping and implementation..<br><br> TypeScript / PDFKit / Commander.js / js-yaml / Vitest<br><br><a href="https://www.npmjs.com/package/rirekisho-cli" target="_blank"><img alt="NPM Version" src="https://img.shields.io/npm/v/rirekisho-cli"></a> <a href="https://www.npmcharts.com/compare/rirekisho-cli?minimal=true" target="_blank"><img alt="NPM Downloads" src="https://img.shields.io/npm/d18m/rirekisho-cli"></a> | <a href="https://github.com/Yuki-Sakaguchi/rirekisho-cli"><img src="https://github.com/user-attachments/assets/bf100c4e-3d7e-46ca-bc1e-e379534a1d03" width="400px" /><br>rirekisho-cli</a> |
| **🔮 gh-wizard** <br>A GitHub CLI extension for instantly creating projects from your template repositories.<br><br>Discover and clone your template repositories with an intuitive, interactive UI. Configure project name, description, and GitHub settings step-by-step, then start coding immediately.<br><br> Go / GitHub CLI / Survey / go-gh / runewidth / Cobra<br><br><a href="https://github.com/Yuki-Sakaguchi/gh-wizard" target="_blank"><img alt="GitHub Release" src="https://img.shields.io/github/v/release/Yuki-Sakaguchi/gh-wizard"></a> | <img src="https://github.com/user-attachments/assets/fb5e10b0-8390-42f7-995d-db69b61b9373" width="400px" /><br><a href="https://github.com/Yuki-Sakaguchi/gh-wizard">gh-wizard</a> |
| **✨ gh-topic-urls** <br>A CLI tool to fetch GitHub Pull Request URLs for a specific branch and copy them to the clipboard in Markdown list format.<br><br>Automatically detects Git repositories, validates branches, and formats PR URLs as Markdown lists. Perfect for quick PR collection and documentation workflows.<br><br> Go / GitHub CLI / Cobra / clipboard<br><br><a href="https://github.com/Yuki-Sakaguchi/gh-topic-urls" target="_blank"><img alt="GitHub Release" src="https://img.shields.io/github/v/release/Yuki-Sakaguchi/gh-topic-urls"></a> | <img src="https://github.com/user-attachments/assets/5e64d4e8-eec8-43fa-a1be-a654a158b66a" width="400px" /><br><a href="https://github.com/Yuki-Sakaguchi/gh-topic-urls">gh-topic-urls</a> |
